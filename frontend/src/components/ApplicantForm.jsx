          ...
          <Form className="p-6 bg-neutral text-neutral-content shadow-md space-y-4 w-1/2 mx-auto text-xl my-10 rounded-3xl border border-accent">
            ...
            <div className="form-control">
              <label htmlFor="sector" className="label">
                <span className="label-text">
                  Secteur d&apos;activité (Ctrl + clic pour sélectionner
                  plusieurs)
                </span>
              </label>
              <Field
            ...
            <div className="form-control">
              <label htmlFor="kilometers_away" className="label">
                <span className="label-text">
                  Distance maximale souhaitée (km)
                </span>
              </label>
              <Field
                as="select"
            ...
            <div className="form-control">
              <label className="label cursor-pointer">
                <span className="label-text">
                  Je ne suis pas inscrit dans une école
                </span>
                <Field
                  type="checkbox"
            ...
            <div className="form-control">
              <label className="label cursor-pointer">
                <span className="label-text">
                  Je ne souhaite pas être contacté par les écoles
                </span>
                <Field
                  type="checkbox"
