    ...
    return (
        <dialog id="details_modal" className="modal modal-open">
            <div className="modal-box bg-base-200">
                <h1 className="text-3xl font-bold text-gray-100 text-center my-6 anton">Détails du Match</h1>
                <div className="py-4 grid grid-cols-1 gap-4">
                    <p><strong>Offre :</strong> {match.offer}</p>
                    <p><strong>Candidature :</strong> {match.application}</p>
                    <p><strong>Score :</strong> {match.score}</p>

                    <div>
                        <strong>Score de l'industrie : {match.industry_score}</strong>
                        <div className="w-full bg-gray-300 rounded-full h-4 mt-1">
                            <div className="bg-blue-600 h-4 rounded-full" style={{ width: `${match.industry_score}%` }}></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="w-full bg-gray-300 rounded-full h-4 mt-1">
                            <div className="bg-green-600 h-4 rounded-full" style={{ width: `${match.test_score}%` }}></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="w-full bg-gray-300 rounded-full h-4 mt-1">
                            <div className="bg-yellow-600 h-4 rounded-full" style={{ width: `${match.geographic_score}%` }}></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="w-full bg-gray-300 rounded-full h-4 mt-1">
                            <div className="bg-red-600 h-4 rounded-full" style={{ width: `${match.resume_score}%` }}></div>
                        </div>
                    </div>
                </div>
                <div className="py-4">
            ...
            <p className="py-4 text-center text-gray-400">Appuyez sur Échap pour fermer</p>
        </dialog>
    );
};
...
const MatchApplicantManagement = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await Axios.put(`/match_applicants/${selectedMatch.id}/`, { status: newStatus });
        ...
        <>
            ...
            <dialog id="status_modal" className="modal">
                <div className="modal-box">
                    <div className="modal-action">
                        <h1 className="text-3xl font-bold text-gray-100 text-center my-10 anton">Mettre à jour le statut</h1>
                        <form onSubmit={handleSubmit} className="rounded m-5 w-full">
                            ...
                            >
                                ...
                                <option value="Canceled_applicant">Canceled by Applicant</option>
                                <option value="Fully_accepted">Fully Accepted</option>
                                <option value="Finalized_enrollment">Finalized Enrollment</option>
                            </select>
                            <button
                                type="submit"
            ...
            <h1 className="text-3xl font-bold text-gray-100 text-center my-10 anton">Matchs des candidats</h1>
            <div className="flex">
