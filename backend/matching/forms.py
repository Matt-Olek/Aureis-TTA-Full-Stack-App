...
class ApplicantForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            'user', 'resume', 
            'first_name', 'last_name', 'email', 'city', 'country', 'phone', 
            'diploma', 'target_educational_level', 'duration', 'contract_type', 
            'sector', 'location', 'kilometers_away', 
            'is_not_signed_in_school', 'do_accept_school', 'skills'
        ]
        widgets = {
            ...
            'is_not_signed_in_school': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'do_accept_school': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
